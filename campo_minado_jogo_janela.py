...
class CampoMinadoJogoJanela:
    ...
    def __init__(self, master):
        ...
        self.__button_08 = Button(master, width=5, height=2, background="#EFEFEF", borderwidth=1, textvariable=self.__label_08, command=self.__button08_click)
        ...
        self.__button_18 = Button(master, width=5, height=2, background="#EFEFEF", borderwidth=1, textvariable=self.__label_18, command=self.__button18_click)
        ...
        self.__button_28 = Button(master, width=5, height=2, background="#EFEFEF", borderwidth=1, textvariable=self.__label_28, command=self.__button28_click)
        ...
        self.__button_38 = Button(master, width=5, height=2, background="#EFEFEF", borderwidth=1, textvariable=self.__label_38, command=self.__button38_click)
        ...
        self.__button_48 = Button(master, width=5, height=2, background="#EFEFEF", borderwidth=1, textvariable=self.__label_48, command=self.__button48_click)
        ...
        self.__button_58 = Button(master, width=5, height=2, background="#EFEFEF", borderwidth=1, textvariable=self.__label_58, command=self.__button58_click)
    ...
    def __mensagem_derrota(self):
        messagebox.showinfo(messagebox.INFO, "Não foi dessa vez! Você perdeu...")
